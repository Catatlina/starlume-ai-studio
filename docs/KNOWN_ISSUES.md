...
- 第三次副本 `fb13d536-a582-42ac-b03d-c3e219e9f1c9`：第1章第2场命中 `scene_first_person_narrative`，真实 Provider 输出中的“吾”未被成对引号包住，第三人称硬门禁按规则阻断；没有放宽规则，也没有落正文。
- 原始作品 `4ee9db30-98c7-40d5-9484-12432efed69e` 未清空、未覆盖；三个失败副本均未续跑。下一步先复盘第三次样本的引号结构/第三人称生成契约，拿到确定性修复和回归证据后再安排一次新副本。
