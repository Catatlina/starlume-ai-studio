...
_EXTERNAL_EVENT_RE = re.compile(
    r"(?:警报|电话|短信|消息|通知|敲门|脚步|爆炸|枪声|雷声|"
    r"钟(?:声|响|鸣)|铃(?:声|响)|广播|来人|有人冲进|"
    r"(?:门外|窗外|屋外|院外|远处).{0,12}(?:传来|响起|响|震动))"
)
_OBJECT_RE = re.compile(
    r"(?:手机|玉佩|令牌|钥匙|账本|合同|文件|屏幕|信封|药瓶|刀|剑|戒指|手表|门锁|门轴|门缝|门面|门板|门框|铜门|木门|灯|光线|微光|裂痕|字迹|灰尘|箱子).{0,20}(?:裂|亮|震|响|掉|落|落下|下落|翻|停|显|渗|透|开|断|出现|变|闪|暗|熄|灭|躺|悬|浮|摆|动)"
